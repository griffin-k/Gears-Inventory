...
function Inventory() {
  ...
  async function generatePDF(inventoryData) {
    ...
    page.drawText("Garrison Engineering & Robotics Society", {
      x: 40,
      y: page.getHeight() - 50,
      font,
      size: 24,
    ...
    page.drawText(`Admin: ${ownerEmail}`, {
      x,
      y,
      font,
      size: 11,
  ...
  return (
    <>
          ...
          <div className="flex flex-row items-start justify-evenly flex-wrap mt-8 smallMobile:gap-3 mobile:gap-5 tablet:gap-5 laptop:gap-0 desktop:gap-0">
            <div
              ...
              style={{
                ...
                // color: `${mode.colorCard}`, ////main card

                backgroundColor: `black`,
                color: `white`, ////main card
              }}
            >
                ...
                >
                  {inventoryArray.length > 0
                    ? `You have ${inventoryArray.length} ${
                        inventoryArray.length > 1 ? "items" : "item"
                      } in your inventory`
              ...
              <table className="tableCSS m-8 border-collapse h-[40vh] overflow-y-scroll block text-left">
                <tbody>
                  ...
                  <tr>
                    <td colSpan={4}>
                        <div className="bg-gray-300 w-10/12 my-3 h-[1px]"></div>
                    </td>
                  </tr>
                  {inventoryArray.map((item, i) => (
                    <tr
                      key={i}
                      className="hover:bg-[#2484ED] transition-all duration-300 rounded-sm"
                    >
                      ...
                      <td>
                        <div
                          onClick={() => {
                            ...
                            setDialogItemName(item.item_name);
                            setDialogItemPrice(item.price);
                            setDialogItemId(item.item_id);
              ...
              >
                ...
                <div className="flex flex-col justify-start items-start gap-2 w-full">
                  <div
                    ...
                    className="flex flex-row justify-start items-center color-white gap-4 border-gray-400 border-2 p-2 rounded-md w-full cursor-pointer"
                  >
                    <AddIcon />
      ...
      <Dialog open={openAddItemDialog} onClose={handleCloseAddItemDialog}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) => setDialogFieldItemPrice(e.target.value)}
          />
        </DialogContent>
      ...
      {/* Edit item dialog box */}
      <Dialog open={opeEditItemDialog} onClose={handleCloseEditItemDialog}>
        ...
        <DialogContent>
          <TextField
            ...
            onChange={(e) => setDialogEditFieldCategory(e.target.value)}
          >
            {categoryArray.map((category) => (
              <MenuItem key={category.category_id} value={category.category_id}>
                {category.category_name}
          ...
          <TextField
            ...
            onChange={(e) => setDialogEditFieldItemName(e.target.value)}
          />
          <TextField
            margin="dense"
            label="Quantity"
            ...
            onChange={(e) => setDialogEditFieldItemPrice(e.target.value)}
          />
        </DialogContent>
        <DialogActions className="mt-2">
          <MuiButton
